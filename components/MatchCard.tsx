        ...
        >
          ...
          <div className="p-6 flex items-center justify-between gap-4">
            ...
            <div className="flex-1 flex flex-col items-center gap-3">
              <div className="relative w-20 h-14 sm:w-24 sm:h-16 rounded-md overflow-hidden shadow-lg border-2 border-white/10 group-hover:border-wc-cyan/50 transition-colors bg-white/5">
            ...
            {/* Team B */}
            <div className="flex-1 flex flex-col items-center gap-3">
              <div className="relative w-20 h-14 sm:w-24 sm:h-16 rounded-md overflow-hidden shadow-lg border-2 border-white/10 group-hover:border-wc-green/50 transition-colors bg-white/5">
